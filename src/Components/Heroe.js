    ...
    <div className="heroe-section" id="heroe-section">
      <div className="heroe-wrapper">
        ...
        <div className="heroe-quote">
          <p>
            <i className="fa fa-quote-left icon" aria-hidden="true"></i>I
            believe in the future of technology, the technology that is
            engineered by people who write and read codes just like me... "
